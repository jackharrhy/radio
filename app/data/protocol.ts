...
export function parseClientMessage(value: unknown): ClientMessage | null {
  ...
  switch (message.type) {
        ...
        return {
          ...
          clientCompensationMs:
            typeof message.clientCompensationMs === 'number'
              ...
              : undefined,
          clientNudgeMs: typeof message.clientNudgeMs === 'number' ? message.clientNudgeMs : undefined,
    ...
    case 'TRACK_READY':
    case 'REMOVE_TRACK':
      if (typeof message.trackId === 'string') return { type: message.type, trackId: message.trackId }
      return null
    case 'PLAY':
    case 'PAUSE':
      if (typeof message.trackId === 'string' && typeof message.trackTimeSeconds === 'number') {
        return { type: message.type, trackId: message.trackId, trackTimeSeconds: message.trackTimeSeconds }
      }
      return null
    case 'SET_VOLUME':
      ...
      return null
    case 'REORDER_TRACKS':
      if (Array.isArray(message.trackIds) && message.trackIds.every((id) => typeof id === 'string')) {
