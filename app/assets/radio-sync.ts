...
export function handleNtpResponse(response: Extract<ServerMessage, { type: 'NTP_RESPONSE' }>): NtpMeasurement | null {
  let t3 = epochNow()
...
export function calculateWaitTimeMilliseconds(targetServerTime: number, clockOffset: number): number {
