/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82dd196e100f6df7fd5d8b241c924ea5)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	TRACKS: R2Bucket;
	ASSETS: Fetcher;
	RADIO_ROOMS: DurableObjectNamespace<import("./worker").RadioRoomCell>;
	ROOM_DIRECTORY: DurableObjectNamespace<import("./worker").RoomDirectoryCell>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "RadioRoomCell" | "RoomDirectoryCell";
	}
